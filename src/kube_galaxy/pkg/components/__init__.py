...
def install_component(
    ...
    """
    Install a component using its legacy install function if available.
    
    This is kept for compatibility with old cluster setup code.
    New code should use component instances and hooks directly.
...
def configure_component(component_name: str) -> None:
    """
    Configure a component using its legacy configure function if available.
...
def remove_component(component_name: str) -> None:
    """
    Remove a component using its remove function if available.
